...
export default {
                  ...
                  on: {
                    click: () => {
                      ...
                      if (params.row.status == 1) {
                        ...
                        self.$http
                          .post(self.host + ":6006/otc//advertise/on/shelves", canshu)
                          .then(response => {
                        ...
                        self.$http
                          .post(
                            self.host + ":6006/otc//advertise/off/shelves",
                            canshu
                          )
                          .then(response => {
                            var resp = response.body;
                    ...
                    click: () => {
                      ...
                      if (params.row.status == 1) {
                        self.$Modal.confirm({
                          ...
                          onOk: () => {
                            self.$http
                              .post(self.host + ":6006/otc//advertise/delete", canshu)
                              .then(response => {
                                var resp = response.body;
                                if (resp.code == 0) {
                                  self.$Message.success(resp.message);
  ...
  methods: {
    ...
    getAd() {
      //获取个人广告
      this.$http.post(this.host + ":6006/otc//advertise/all").then(response => {
        var resp = response.body;
        if (resp.code == 0) {
