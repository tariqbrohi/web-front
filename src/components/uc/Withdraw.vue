...
export default {
  ...
  methods: {
    ...
    sendCode() {
      this.$http.post(this.host + ":6001/uc/mobile/withdraw/code").then(response => {
    ...
    ok() {
      ...
      this.$http
        .post(this.host + ":6001/uc/withdraw/apply/code", params)
        .then(response => {
          this.fundpwd = "";
          var resp = response.body;
          if (resp.code == 0) {
    ...
    getAddrList() {
      ...
      //获取地址
      this.$http
        .post(this.host + ":6001/uc/withdraw/support/coin/info")
        .then(response => {
          var resp = response.body;
    ...
    getList() {
      ...
      this.$http
        .post(this.host + ":6001/uc/withdraw/record", params)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
