...
export default {
  ...
  data() {
    ...
    return {
      ...
      uploadUrl: this.host + ":6001/uc/upload/oss/image",
  ...
  methods: {
    ...
    submit(name) {
      ...
      if (name == "formValidate6") {
        ...
        this.$http
          .post(this.host + ":6001/uc/approve/real/name", param)
          .then(response => {
      ...
      if (name == "formValidate2") {
        ...
        this.$http
          .post(this.host + ":6001/uc/approve/bind/email", param)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
              this.$Message.success(this.$t("uc.safe.save_success"));
      ...
      if (name == "formValidate3") {
        ...
        this.$http
          .post(this.host + ":6001/uc/approve/bind/phone", param)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
              this.$Message.success(this.$t("uc.safe.save_success"));
      ...
      if (name == "formValidate4") {
        ...
        this.$http
          .post(this.host + ":6001/uc/approve/update/password", param)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
              this.$Message.success(this.$t("uc.safe.save_success"));
      ...
      if (name == "formValidate5") {
        ...
        this.$http
          .post(this.host + ":6001/uc/approve/update/transaction/password", param)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
              this.$Message.success(this.$t("uc.safe.save_success"));
      ...
      if (name == "formValidate7") {
        ...
        this.$http
          .post(this.host + ":6001/uc/approve/transaction/password", param)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
              this.$Message.success(this.$t("uc.safe.save_success"));
      ...
      if (name == "formValidate8") {
        ...
        this.$http
          .post(this.host + ":6001/uc/approve/reset/transaction/password", param)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
              this.$Message.success(this.$t("uc.safe.save_success"));
    ...
    send(index) {
      ...
      if (index == 1) {
        if (this.formValidate2.mail) {
          //获取邮箱code
          this.$http
            .post(this.host + ":6001/uc/bind/email/code", {
        ...
        if (this.formValidate3.mobile) {
          //获取手机code
          this.$http
            .post(this.host + ":6001/uc/mobile/bind/code", {
        ...
        //登录密码获取手机code
        this.$http
          .post(this.host + ":6001/uc/mobile/update/password/code")
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
        ...
        //资金密码获取手机code
        this.$http
          .post(this.host + ":6001/uc/mobile/transaction/code")
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
    ...
    getMember() {
      ...
      var self = this;
      this.$http
        .post(this.host + ":6001/uc/approve/security/setting")
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
            this.user = resp.data;
