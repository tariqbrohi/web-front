...
export default {
    ...
    methods: {
        ...
        submit(name) {
            ...
            if (name == 'formValidate1') {
              ...
              if (this.user.bankVerified==1) { //修改
                this.$http.post(this.host + ':6001/uc/approve/update/bank', param).then(response => {
                ...
                this.$http.post(this.host + ':6001/uc/approve/bind/bank', param).then(response => {
                    var resp = response.body;
                    if (resp.code == 0) {
                        this.$Message.success(this.$t('uc.account.save_success'));
                        this.getAccount()
            ...
            if (name == 'formValidate2') {
                ...
                if (this.user.aliVerified==1){
                  this.$http.post(this.host + ':6001/uc/approve/update/ali', param).then(response => {
                    var resp = response.body;
                    if (resp.code == 0) {
                      this.$Message.success(this.$t('uc.account.save_success'));
                      this.getAccount()
                  ...
                  this.$http.post(this.host + ':6001/uc/approve/bind/ali', param).then(response => {
                      var resp = response.body;
                      if (resp.code == 0) {
                          this.$Message.success(this.$t('uc.account.save_success'));
                          this.getAccount()
            ...
            if (name == 'formValidate3') {
              ...
              if(this.user.wechatVerified==1) {
                this.$http.post(this.host + ':6001/uc/approve/update/wechat', param).then(response => {
                  var resp = response.body;
                  if (resp.code == 0) {
                    this.$Message.success(this.$t('uc.account.save_success'));
                    this.getAccount()
                ...
                this.$http.post(this.host + ':6001/uc/approve/bind/wechat', param).then(response => {
                    var resp = response.body;
                    if (resp.code == 0) {
                        this.$Message.success(this.$t('uc.account.save_success'));
                        this.getAccount()
        ...
        getAccount() {
            //获取个人账户信息
            this.$http.post(this.host + ':6001/uc/approve/account/setting').then(response => {
                var resp = response.body;
                // console.log(resp);
                if (resp.code == 0) {
                    this.user = resp.data;
