...
export default {
  ...
  methods: {
    ...
    getCodeInfo(){
      ...
      this.$http
        .post(this.host + ":6001/uc/withdrawcode/apply/info", param)
        .then(response => {
    ...
    submitCode(){
      ...
      this.$http
        .post(this.host + ":6001/uc/withdrawcode/apply/recharge", param)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
    ...
    getList(pageN) {
      ...
      this.$http.post(this.host + ":6001/uc/asset/transaction/all", params).then(response => {
          var resp = response.body;
          if (resp.code == 0) {
            if (resp.data) {
