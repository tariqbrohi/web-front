...
export default {
  ...
  methods: {
    ...
    confrimExchange(){
      ...
      this.$http
        .post(this.host + ":6001/uc/asset/wallet/quick-exchange", params)
        .then(response => {
    ...
    getMoney() {
      //获取
      this.$http.post(this.host + ":6001/uc/asset/wallet").then(response => {
        var resp = response.body;
        if (resp.code == 0) {
    ...
    getGCCMatchAmount() {
      //获取
      this.$http
        .post(this.host + ":6001/uc/asset/wallet/match-check")
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
            this.canMatch = true;
    ...
    matchGCC() {
      if (this.matchAmount <= 0) {
        ...
        this.$http
          .post(this.host + ":6001/uc/asset/wallet/match", params)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
    ...
    resetAddress(unit) {
      ...
      params["unit"] = unit;
      this.$http
        .post(this.host + ":6001/uc/asset/wallet/reset-address", params)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
    ...
    confrimTrans: function(){
      ...
      params["amount"] = this.transAmount;
      this.$http
        .post(this.host + ":6001/uc/asset/wallet/trans-usd", params)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
            this.$Message.success(resp.message);
