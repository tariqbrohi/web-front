...
export default {
  ...
  methods: {
    ...
    getCoin() {
      //币种
      this.$http
        .post(this.host + ":6001/uc/withdraw/support/coin")
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
    ...
    getList(pageNo, pageSize) {
      ...
      this.$http
        .post(this.host + ":6001/uc/withdraw/address/page", params)
        .then(response => {
          var resp = response.body;
    ...
    send(index) {
      ...
      if (index == 1) {
        if (this.formValidateAddr.email) {
          //获取邮箱code
          this.$http.post(this.host + ":6001/uc/add/address/code").then(response => {
            var resp = response.body;
            if (resp.code == 0) {
        ...
        if (this.formValidateAddr.mobileNo) {
          //获取手机code
          this.$http
            .post(this.host + ":6001/uc/mobile/add/address/code")
            .then(response => {
              var resp = response.body;
              if (resp.code == 0) {
                this.$Message.success(resp.message);
    ...
    del(id) {
      ...
      this.$Modal.confirm({
        ...
        onOk: () => {
          ...
          params["id"] = id;
          this.$http
            .post(this.host + ":6001/uc/withdraw/address/delete", params)
            .then(response => {
              var resp = response.body;
              if (resp.code == 0) {
                this.$Message.success(resp.message);
    ...
    submit(name) {
      ...
      this.$http
        .post(this.host + ":6001/uc/withdraw/address/add", param)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
