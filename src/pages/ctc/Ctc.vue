...
export default {
                ...
                "Button",
                {
                  ...
                  on: {
                    click: () => {
                      ...
                      this.$Spin.show();
                      this.$http
                        .post(this.host + ":6001/uc/ctc/detail", rparams)
                        .then(response => {
  ...
  methods: {
    ...
    payOrder: function(){
      ...
      this.$Spin.show();
      this.$http
        .post(this.host + ":6001/uc/ctc/pay-ctc-order", params)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
            this.getOrderList();
    ...
    cancelOrder: function(){
      ...
      this.$Spin.show();
      this.$http
        .post(this.host + ":6001/uc/ctc/cancel-ctc-order", params)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
            this.getOrderList();
    ...
    getC2cPrice(){
      this.$http
        .post(this.host + ":6004/market/ctc-usdt")
        .then(response => {
          var resp = response.body;
    ...
    getOrderList(){
      ...
      this.orders = [];
      this.$http
        .post(this.host + ":6001/uc/ctc/page-query", params)
        .then(response => {
          var resp = response.body;
          let rows = [];
          if(resp.code == 0){
    ...
    createOrder(){
      ...
      this.$Spin.show();
      this.$http
        .post(this.host + ":6001/uc/ctc/new-ctc-order", params)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
            this.getOrderList();
    ...
    sendCode() {
      this.$http.post(this.host + ":6001/uc/mobile/ctc/code").then(response => {
        var resp = response.body;
        if (resp.code == 0) {
          this.settime();
          this.$Notice.success({
