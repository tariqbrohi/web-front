...
export default {
  ...
  methods: {
    ...
    ok1() {
      this.$http
        .post(this.host + ":6006/otc//order/pay", {
    ...
    ok3() {
      this.$http
        .post(this.host + ":6006/otc//order/cancel", {
          orderSn: this.$route.query.tradeId
        })
        .then(response => {
          var resp = response.body;
    ...
    ok4() {
      ...
      if (1 == 1) {
        ...
        this.$http
          .post(this.host + ":6006/otc//order/appeal", params)
          .then(response => {
            var resp = response.body;
            if (resp.code == 0) {
              this.$Message.success(resp.message);
    ...
    ok5() {
      ...
      this.$http
        .post(this.host + ":6006/otc//order/release", params)
        .then(response => {
          var resp = response.body;
          if (resp.code == 0) {
            this.$Message.success(resp.message);
    ...
    getDetail() {
      //获取个人广告
      this.$http
        .post(this.host + ":6006/otc//order/detail", {
          orderSn: this.$route.query.tradeId
        })
        .then(response => {
          var resp = response.body;
