<template>
  <div class="nav-right tradeCenter">
	      <div style="background-image: linear-gradient( 135deg, #F0A70A 40%, #0D25B9 100%);text-align: center;height:30px;line-height:30px;letter-spacing: 1px;">In Progress...</div>
