    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.service')}}：service@coin.pro</p>
          <p>{{$t('description.support')}}：support@coin.pro</p>
          <p>{{$t('description.apply')}}：apply@coin.pro</p>
          <p>{{$t('description.report')}}：ceo@coin.pro</p>
          <p>{{$t('description.coop')}}：coop@coin.pro</p>
        </div>
        <div class="content1" style="border:none;">
          <h5>{{$t('description.community')}}</h5>
          <p>{{$t('description.wechat')}}：{{$t('description.addwechat')}}</p>
          <p>{{$t('description.weibo')}}：https://weibo.com/coinpro</p>
          <p>{{$t('description.twitter')}}：https://twitter.com/CoinProGlobal</p>
          <p>{{$t('description.biyong')}}：https://0.plus/coinproofficial</p>
          <p>{{$t('description.telegram')}}：https://t.me/coinproofficial</p>
          <p>{{$t('description.medium')}}：https://medium.com/@CoinPro</p>
          <p>{{$t('description.reddit')}}：https://www.reddit.com/u/coinproglobal</p>
        </div>
      </div>
    </div>
  </div>
