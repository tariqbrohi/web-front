...
export default {
  ...
  methods: {
    ...
    loadNoticeInfo() {
      ...
      this.$http
        .post(this.host + ":6001/uc/announcement/more", param)
        .then(response => {
          ...
          if (result.code == 0) {
            ...
            window.document.title = (this.lang == "zh_CN" ? "公告 - " : "Announcement - ") + this.data.info.title + " - CoinPro | Global digital currency trading platform";
          }else{
