  ...
  <div class="invite">
      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          ...
          <div class="item" @click="useInviteImage">
              <img src="../../assets/images/promotion/invitebg.jpg"></img>
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      ...
      <div class="ptcard-info">
        ...
        <p class="detail">{{$t('invite.pt_card_rule1')}}：promotion@coin.pro。</p>
  ...
  data() {
    ...
    return {
      ...
      myInfo: {
        ...
        extrareward: 0,
        partnerlevel: "-",
        inviteLink: "https://www.coin.pro/register?code=000000"
      },
      promotionRecordPage: {
        pageNo: 1,
        pageSize: 10
