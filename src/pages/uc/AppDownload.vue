  ...
  <div class="login_form app-download">
    <div class="login_right">
      <div style="color: #000;margin-bottom: 60px;padding-top: 160px;width: 100%;text-align:center;z-index: 10;">
        ...
        <p style="font-size:18px;">CoinPro</p>
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="../../assets/images/logo.png"></img></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      window.document.title = (this.lang == "zh_CN" ? "APP下载 - " : "APP Download - ") + "CoinPro | Global digital currency trading platform";
      this.getVersion();
    },
    downloadClick(){
      if(this.isWeiXin()){
        ...
        location.href = "/appdownload/CoinPro.apk";
      }
    },
    downloadClick2(){
      if(this.isWeiXin()){
        ...
        location.href = "https://testflight.apple.com/join";
      }
    },
    coverClick(){
    ...
    getVersion(){
      let self = this;
      this.$http
        .post(this.host + ":6001/uc/ancillary/system/app/version/0", null)
        .then(response => {
