  ...
  <div class="login_form mob-login">
    <div class="login_right">
      <div style="color: #F90;margin-bottom: 60px;margin-top: 60px;">
        <h1 style="border-left: 5px solid #F90;padding-left: 10px;letter-spacing: 2px;line-height:30px;height:30px;">COIN.PRO</h1>
...
export default {
  ...
  methods: {
          ...
          if (this.agree == true) {
            if (this.changeActive == 1) {
              ...
              if (this.isRegister) {
                ...
                this.$http
                  .post(this.host + ":6001/uc/register/phone", params)
                  .then(response => {
    ...
    success() {
      ...
      params["country"] = "中国";
      var reg = /^[1][3,4,5,6,7,8,9][0-9]{9}$/;
      // reg.test(params["phone"]) && this.$http.post(this.host + ":6001/uc/mobile/code", params).then(response => {
      this.$http.post(this.host + ":6001/uc/mobile/code", params).then(response => {
            var resp = response.body;
