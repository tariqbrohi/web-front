...
export default {
  ...
  methods: {
    ...
    publishAd() {
      this.$router.push(":6001/uc/ad/create");
    },
    returnAdit() {
    ...
    returnAudit() {
      ...
      this.$http
        .post(this.host + ":6001/uc/approve/cancel/business", params)
        .then(res => {
          let resp = res.body;
          if (resp.code == 0) {
    ...
    getAuthFound() {
      this.$http
        .get(this.host + ":6001/uc/approve/business-auth-deposit/list")
        .then(res => {
          var resp = res.body;
          if (resp.code == 0) {
    ...
    apply3(form) {
      ...
      this.$http
        .post(this.host + ":6001/uc/approve/certified/business/apply", params)
        .then(res => {
          var resp = res.body;
          if (resp.code == 0) {
            this.$Message.success("提交成功!");
